...
interface ChatRepository {
    ...
    suspend fun createChat(userId: String, title: String, mode: ChatMode = ChatMode.STANDARD): ChatThread
    ...
    suspend fun updateStateMachineSession(userId: String, chatId: String, session: StateMachineSession?)
